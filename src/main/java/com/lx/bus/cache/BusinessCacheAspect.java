...
public class BusinessCacheAspect {
    ...
    //声明一个切面
    private static final String POINTCUT_CUSTOMER_ADD="execution(* com.lx.bus.service.impl.CustomerServiceImpl.save(**))";
    private static final String POINTCUT_CUSTOMER_UPDATE="execution(* com.lx.bus.service.impl.CustomerServiceImpl.updateById(**))";
    private static final String POINTCUT_CUSTOMER_GET="execution(* com.lx.bus.service.impl.CustomerServiceImpl.getById(**))";
    private static final String POINTCUT_CUSTOMER_DELETE="execution(* com.lx.bus.service.impl.CustomerServiceImpl.removeById(**))";
    private static final String POINTCUT_CUSTOMER_BATCHDELETE="execution(* com.lx.bus.service.impl.CustomerServiceImpl.removeByIds(**))";
    ...
    //声明一个切面
    private static final String POINTCUT_PROVIDER_ADD="execution(* com.lx.bus.service.impl.ProviderServiceImpl.save(**))";
    private static final String POINTCUT_PROVIDER_UPDATE="execution(* com.lx.bus.service.impl.ProviderServiceImpl.updateById(**))";
    private static final String POINTCUT_PROVIDER_GET="execution(* com.lx.bus.service.impl.ProviderServiceImpl.getById(**))";
    private static final String POINTCUT_PROVIDER_DELETE="execution(* com.lx.bus.service.impl.ProviderServiceImpl.removeById(**))";
    private static final String POINTCUT_PROVIDER_BATCHDELETE="execution(* com.lx.bus.service.impl.ProviderServiceImpl.removeByIds(**))";
    ...
    public Object cacheProviderGet(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (res1 != null) {
            log.info("已从缓存里面找到客户对象" + CACHE_PROVIDER_PROFIX + object);
            return res1;
        } else {
            Provider res2 = (Provider) joinPoint.proceed();
            CACHE_CONTAINER.put(CACHE_PROVIDER_PROFIX + res2.getId(), res2);
            log.info("未从缓存里面找到客户对象，去数据库查询并放到缓存"+CACHE_PROVIDER_PROFIX+res2.getId());
            return res2;
        }
    }
    ...
    public Object cacheProviderUpdate(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (isSuccess) {
            ...
            BeanUtils.copyProperties(deptVo, dept);
            log.info("客户对象缓存已更新" + CACHE_PROVIDER_PROFIX + deptVo.getId());
    ...
    public Object cacheProviderBatchDelete(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        //商品数据的缓存 声明切面表达式
        private static final String POINTCUT_GOODS_ADD = "execution(* com.lx.bus.service.impl.GoodsServiceImpl.save(..))";
        private static final String POINTCUT_GOODS_UPDATE = "execution(* com.lx.bus.service.impl.GoodsServiceImpl.updateById(..))";
        private static final String POINTCUT_GOODS_GET = "execution(* com.lx.bus.service.impl.GoodsServiceImpl.getById(..))";
        private static final String POINTCUT_GOODS_DELETE = "execution(* com.lx.bus.service.impl.GoodsServiceImpl.removeById(..))";
